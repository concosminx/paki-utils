...
[![Java CI](https://github.com/concosminx/paki-utils/actions/workflows/1.pipeline.yml/badge.svg)](https://github.com/concosminx/paki-utils/actions/workflows/1.pipeline.yml)
[![Maven Central](https://img.shields.io/maven-central/v/eu.pakithecat/utils.svg)](https://central.sonatype.com/artifact/eu.pakithecat/utils)
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](CODE_OF_CONDUCT.md)
[![Javadoc](https://img.shields.io/badge/JavaDoc-Online-green)](https://concosminx.github.io/paki-utils/javadoc/)
...
2. Create & provide a PAT (Personal Access Token) for the CI/CD pipeline
   ...
   1. If the new repo owner is an organisation, **enrol** the organisation for '**Fine-grained personal access tokens**'. In the organisation ['Settings > Third-party Access > Personal access tokens'](https://github.com/organizations/concosminx/settings/personal-access-tokens).
...
4. Final one-off tasks
   ...
   * Update _Maven Publication_ details [here](utils/build.gradle.kts#L6-L13)
...
* `utils/`: The library source code (Gradle sub-project).
...
## CI/CD Pipeline
The heart of this template is the ['Main GitHub Actions CI/CD Pipeline'](https://github.com/concosminx/paki-utils/actions/workflows/1.pipeline.yml).
...
Please define the secrets via your repository settings. ([Settings > Security > Secrets and variables > Actions](https://github.com/concosminx/paki-utils/settings/secrets/actions))
...
To host the generated Javadoc, configure GitHub Pages for your repository to deploy from branch `gh-pages`. You can also find all deployments under ['pages-build-deployment'](https://github.com/concosminx/paki-utils/actions/workflows/pages/pages-build-deployment).
...
The libraries gradle dependencies are scanned for known [CVE](https://www.cve.org/) with **[aquasecurity/trivy](https://github.com/aquasecurity/trivy)**. The scan results can be reviewed and managed under [Security > Vulnerability alerts > Code scanning](https://github.com/concosminx/paki-utils/security/code-scanning).
